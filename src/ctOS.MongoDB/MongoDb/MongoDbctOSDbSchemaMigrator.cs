...
public class MongoDbctOSDbSchemaMigrator : IctOSDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbctOSDbSchemaMigrator(IServiceProvider serviceProvider)
    {
